        ...
        $roles = [
            'superadmin' => [
                ...
                'permissions' => [
                    ...
                    'manage-any-helpdesk-tickets',
                    'view-helpdesk-tickets',
                    'create-helpdesk-tickets',
                    'edit-helpdesk-tickets',
                    'delete-helpdesk-tickets',
                    'manage-helpdesk-categories',
                    'create-helpdesk-categories',
                    'edit-helpdesk-categories',
                    'delete-helpdesk-categories',
                    'manage-helpdesk-replies',
                    'create-helpdesk-replies',
                    'delete-helpdesk-replies',
                    'manage-settings',
                    'edit-settings',
