import{b as j,j as c,R as le}from"./ui-BSZZ9r9D.js";import{X as ae}from"./app-BONBhPjq.js";import{D as pe,a as de,b as ce,c as me}from"./dialog-06p33AB2.js";import{B as Gt}from"./button-CNAj7G3n.js";import{b as Vt}from"./helpers-6tdtanYE.js";import{r as Ut}from"./proposalShortcodes-DxWzcDU5.js";import{c as ot}from"./utils-DqweA7RH.js";import{u as ue}from"./useTranslation-DlVResIr.js";import{F as he}from"./file-text-DbHHDKqD.js";import{P as Wt}from"./printer-DA-p1RZw.js";import{E as ge}from"./eye-BNGhHsW_.js";const Dt="#E9591C",te="html-preview-container";function Xt(e){return e?/<style|<link\s+rel|<!doctype|<html|<head|<svg|position:\s*absolute|297mm|210mm/i.test(e):!1}function ee(e,n){let r=e.replace(/@(media|supports)\b[^{]*\{([\s\S]*?\})\s*\}/gi,(d,t,o)=>{const u=d.slice(0,d.indexOf("{")+1),p=ee(o,n);return`${u}
${p}
