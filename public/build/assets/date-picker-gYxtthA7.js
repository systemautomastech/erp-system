import{b as u,j as t}from"./ui-BSZZ9r9D.js";import{D as z}from"./react-datepicker-L7j15Mjt.js";import{c as h}from"./utils-DqweA7RH.js";import{B as M}from"./button-CNAj7G3n.js";import{P as B,a as F,b as Y}from"./popover-Cnb_Bc7C.js";import{u as Z}from"./useTranslation-DlVResIr.js";import{C as O}from"./calendar-DYWrKXQV.js";function G({value:r,onChange:p,placeholder:k,className:g,id:s,required:m,maxDate:w,minDate:f,showYearDropdown:_=!0,showMonthDropdown:b=!0,style:x,disabled:y=!1,filterDate:v}){const{t:D}=Z(),[j,l]=u.useState(!1);u.useEffect(()=>{if(r&&(r.includes("T")||r.includes("Z"))){const e=S(r);e!==r&&p(e)}},[r]);const S=e=>{if(!e)return"";if(e.includes("T")&&e.includes("Z")){const a=new Date(e),o=a.getFullYear(),n=String(a.getMonth()+1).padStart(2,"0"),c=String(a.getDate()).padStart(2,"0");return`${o}-${n}-${c}`}return e.split("T")[0]},C=e=>{if(!e)return null;if(e.includes("T")&&e.includes("Z")){const i=new Date(e),P=i.getFullYear(),T=i.getMonth(),$=i.getDate();return new Date(P,T,$,12,0,0)}const a=e.split("T")[0],[o,n,c]=a.split("-").map(Number);return new Date(o,n-1,c,12,0,0)},E=e=>{if(!e)return"";const a={year:"numeric",month:"short",day:"numeric"};return e.toLocaleDateString("en-US",a)},d=C(r),N=e=>{if(e){const a=e.getFullYear(),o=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),c=`${a}-${o}-${n}`;p(c),l(!1)}else p("")};return t.jsxs("div",{className:h("w-full",g),children:[s&&t.jsx("input",{id:s,type:"hidden",value:r||"",required:m}),t.jsxs(B,{open:j,onOpenChange:l,children:[t.jsx(F,{asChild:!0,children:t.jsxs(M,{variant:"outline",className:h("w-full justify-start text-left font-normal h-10",!r&&"text-muted-foreground"),style:x,disabled:y,children:[t.jsx(O,{className:"mr-2 h-4 w-4"}),r&&d?E(d):k||D("Select date")]})}),t.jsx(Y,{className:"w-auto p-0",align:"start",children:t.jsx("div",{className:"date-picker-wrapper",children:t.jsx(z,{selected:d,onChange:N,inline:!0,showPopperArrow:!1,maxDate:w,minDate:f,showYearDropdown:_,showMonthDropdown:b,dropdownMode:"select",yearDropdownItemNumber:100,filterDate:v})})})]}),t.jsx("style",{children:`
