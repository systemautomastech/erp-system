...
`;function Nt(o){if(typeof document>"u")return o*3.7795275591;const t=document.createElement("div");t.style.cssText=`
    ...
    `;const t=document.createElement("div");t.style.cssText=`
        ...
        min-height: 0;
        box-sizing: border-box;
    `,o.appendChild(t),document.body.appendChild(o);const n=t.getBoundingClientRect().height;return o.remove(),n||Nt(Wt)-Nt(Kt)-Nt(Xt)}const U=1;function Oe(o){if(typeof window>"u")return 0;const t=window.getComputedStyle(o);return(parseFloat(t.marginTop)||0)+(parseFloat(t.marginBottom)||0)}function Be(o){const t=o.getBoundingClientRect();return t.height>0?t.height:o.offsetHeight||0}function Rt(o){return Be(o)+Oe(o)}function K(o,t){return t===void 0||/data-proposal-section-index=/.test(o)?o:o.replace(/^<(\w+)(\s|>)/,`<$1 data-proposal-section-index="${kt(t)}"$2`)}function kt(o){return o.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Re(o){var t,n,g,e,i;return((t=o.classList)==null?void 0:t.contains("page-break"))||((n=o.style)==null?void 0:n.pageBreakAfter)==="always"||((g=o.style)==null?void 0:g.pageBreakBefore)==="always"||((e=o.style)==null?void 0:e.breakAfter)==="page"||((i=o.style)==null?void 0:i.breakBefore)==="page"}function Ie(o){var t,n,g,e,i;return o.hasAttribute("data-full-page")||((t=o.classList)==null?void 0:t.contains("cover-page-wrapper"))||((g=(n=o.style)==null?void 0:n.height)==null?void 0:g.includes("297mm"))||((i=(e=o.style)==null?void 0:e.minHeight)==null?void 0:i.includes("297mm"))}function Fe(o){const t=o.tagName.toLowerCase();return(t==="div"||t==="section"||t==="article"||t==="main")&&o.children.length>0&&!o.classList.contains("page-break")}function ot(o,t){const n=document.createElement("div");n.style.cssText=`
        position: absolute;
        visibility: hidden;
        pointer-events: none;
        ...
        box-sizing: border-box;
    `,n.innerHTML=t,o.appendChild(n);const g=n.getBoundingClientRect().height,e=n.scrollHeight;return n.remove(),Math.max(g,e,0)}function we(o,t){const n=o.cloneNode(!1);return t.forEach(g=>{n.appendChild(g.cloneNode(!0))}),n.outerHTML}function ve(o){const t=Array.from(o.children).find(n=>n.tagName.toLowerCase()==="table");return t||null}function Ne(o,t){const n=Array.from(o.children),g=n.indexOf(t);if(g<=0)return null;const e=n[g-1];if(!e)return null;const i=e.tagName.toLowerCase();return i==="div"||i==="h1"||i==="h2"||i==="h3"||i==="h4"||i==="h5"||i==="h6"||i==="p"?e:null}function qe(o,t,n){const g=Array.from(o.childNodes);if(g.length!==1)return null;const e=g[0];if(e.nodeType!==Node.TEXT_NODE)return null;const i=e.textContent||"";if(!i.trim())return null;const h=i.split(/(\s+)/);if(h.length<=1)return null;const d=[];let _="";const z=T=>{const s=o.cloneNode(!1);return s.textContent=T,ot(t,s.outerHTML)<=n+U};for(const T of h){const s=_+T;_.trim()&&!z(s)?(d.push(_.trim()),_=T):_=s}return _.trim()&&d.push(_.trim()),d.length<=1?null:d.map(T=>{const s=o.cloneNode(!1);return s.textContent=T,s.outerHTML})}function Ge(o,t,n){const g=Array.from(o.childNodes);if(g.length<=1)return null;const e=[];let i=[];const h=()=>{i.length!==0&&(e.push(we(o,i)),i=[])};for(const d of g){const _=[...i,d],z=we(o,_),T=ot(t,z);i.length>0&&T>n+U?(h(),i=[d]):i.push(d)}return h(),e.length>1?e:null}function Te(o,t,n,g){const e=Ge(o,t,n);if(e&&e.length>1)return e.map(d=>K(d,g));const i=qe(o,t,n);if(i&&i.length>1)return i.map(d=>K(d,g));const h=o.cloneNode(!0);return h.classList.add("proposal-pagination-splittable"),[K(h.outerHTML,g)]}function Qt(o,t,n,g,e,i){const h=o.getAttribute("class")||"",d=o.getAttribute("style")||"",_=i!==void 0?` data-proposal-section-index="${kt(i)}"`:"";return`<table class="${kt(h)}"${_} style="${kt(d)}">`+n+`<tbody>${t.join("")}</tbody>`+(e?g:"")+"</table>"}function Yt(o,t=It()){const n=Array.from(o.querySelectorAll("style")).map(s=>s.outerHTML).join(`
`),g=[];let e=[],i=0;const h=Math.max(1,t-U),d=()=>{e.length!==0&&(g.push((n?n+`
`:"")+e.join("")),e=[],i=0)},_=(s,k)=>{e.push(s),i+=k},z=(s,k,q,b)=>{const A=k.querySelector("thead"),Q=k.querySelector("tfoot"),R=Array.from(k.querySelectorAll("tbody > tr")),Z=A?A.outerHTML:"",r=Q?Q.outerHTML:"",j=q?K(q.outerHTML,b):"";if(R.length===0){const y=Qt(k,[],Z,r,!0,b),c=j+y,w=ot(o,c);i>0&&i+w>h+U&&d(),_(c,w);return}let $=0,p=!0;for(;$<R.length;){const y=[];for(;$<R.length;){const D=R[$],dt=[...y,D.outerHTML],X=$===R.length-1,V=Qt(k,dt,Z,r,X,b),S=p?j+V:V,E=ot(o,S);if(i+E<=h+U){y.push(D.outerHTML),$++;continue}if(y.length>0)break;if(e.length>0&&i>0){d();continue}const nt=D.cloneNode(!0);nt.classList.add("proposal-oversized-row"),y.push(nt.outerHTML),$++;break}if(y.length===0)break;const c=$>=R.length,w=Qt(k,y,Z,r,c,b),x=p?j+w:w,G=ot(o,x);i>0&&i+G>h+U&&d(),_(x,G),p=!1,c||d()}},T=(s,k)=>{const b=s.getAttribute("data-proposal-section-index")??k,A=s.tagName.toLowerCase();if(A==="style"||A==="script")return;if(Re(s)){d();const r=ve(s);if(r){const p=Ne(s,r);z(s,r,p,b);const y=Array.from(s.children),c=y.indexOf(r);for(let w=c+1;w<y.length;w++)T(y[w],b);return}const j=K(s.outerHTML,b),$=Rt(s);_(j,$),d();return}if(Ie(s)){e.length>0&&d();const r=K(s.outerHTML,b);e.push(r),i=Rt(s),d();return}if(A==="table"){z(s,s,null,b);return}const Q=ve(s);if(Q){const r=Array.from(s.children),j=r.indexOf(Q),$=Ne(s,Q),p=$?r.indexOf($):j;for(let y=0;y<Math.max(0,p);y++)T(r[y],b);z(s,Q,$,b);for(let y=j+1;y<r.length;y++)T(r[y],b);return}if((A==="ul"||A==="ol")&&s.children.length>0){const r=s.getAttribute("class")||"",j=s.getAttribute("style")||"",$=Array.from(s.children);let p=[];const y=()=>{if(p.length===0)return;const c=`<${A} class="${kt(r)}" style="${kt(j)}">`+p.join("")+`</${A}>`,w=ot(o,c);_(K(c,b),w),p=[]};for(let c=0;c<$.length;c++){const w=$[c],x=[...p,K(w.outerHTML,b)],G=`<${A}>${x.join("")}</${A}>`,D=ot(o,G);if(i+D>h+U){if(p.length>0&&(y(),d()),ot(o,`<${A}>${K(w.outerHTML,b)}</${A}>`)<=h+U){p.push(K(w.outerHTML,b));continue}const X=Te(w,o,h,b);X.forEach((V,S)=>{e.length>0&&i>0&&d();const E=ot(o,V);_(V,E),S<X.length-1&&d()});continue}p.push(K(w.outerHTML,b))}y();return}if(Fe(s)){const r=Rt(s);if(i+r<=h+U){_(K(s.outerHTML,b),r);return}const j=Array.from(s.children);if(j.length>0){j.forEach($=>T($,b));return}}const R=Rt(s);if(i+R<=h+U){_(K(s.outerHTML,b),R);return}if(e.length>0&&d(),R<=h+U){_(K(s.outerHTML,b),R);return}const Z=Te(s,o,h,b);Z.forEach((r,j)=>{e.length>0&&i>0&&d();const $=ot(o,r);_(r,$),j<Z.length-1&&d()})};return Array.from(o.children).forEach(s=>{T(s)}),e.length>0&&d(),g.length>0?g:[o.innerHTML]}const W=o=>(Number(o)||0).toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}),Ft=He.memo(({children:o,content:t,backgroundImage:n,defaultBg:g,templateColor:e=ke,headerLogo:i,headerLogoAlign:h="right",pageKey:d,className:_="",customHtml:z=!1})=>{const T=n&&String(n).trim()!==""?n:g,s=T?qt(T):"",k=i?qt(i):"",q=()=>{const b=h||"right";return b==="left"?{top:"8mm",left:"15mm",right:"auto",justifyContent:"flex-start",maxHeight:"20mm",maxWidth:"60mm"}:b==="center"||b==="middle"?{top:"8mm",left:"50%",right:"auto",transform:"translateX(-50%)",justifyContent:"center",maxHeight:"20mm",maxWidth:"60mm"}:{top:"8mm",right:"15mm",left:"auto",justifyContent:"flex-end",maxHeight:"20mm",maxWidth:"60mm"}};return u.jsxs("div",{style:{width:"210mm",...z?{minHeight:"297mm",boxSizing:"border-box"}:{height:"297mm",minHeight:"297mm",maxHeight:"297mm",boxSizing:"border-box",overflow:"hidden"},pageBreakAfter:"always",breakAfter:"page",pageBreakInside:"avoid",breakInside:"avoid-page",fontFamily:'"Open Sans", sans-serif',"--template-color":e},className:Tt("proposal-preview-sheet proposal-cover__sheet bg-white text-slate-900 w-[210mm] max-w-full shadow-2xl rounded-sm text-sm border border-slate-300 dark:border-slate-800 shrink-0 relative",!z&&"h-[297mm] overflow-hidden",_),children:[s&&u.jsx("div",{className:"absolute inset-0 w-full h-full z-0 pointer-events-none overflow-hidden",children:u.jsx("img",{src:s,alt:"Page Background",className:"w-full h-full object-fill block"})}),k&&u.jsx("div",{className:"absolute z-20 pointer-events-none flex items-center",style:q(),children:u.jsx("img",{src:k,alt:"Header Logo",className:"max-h-[16mm] max-w-[55mm] object-contain"})}),u.jsx("div",{className:Tt(!z&&"proposal-page__body",z&&"w-full h-full p-0 m-0"),style:{position:"relative",zIndex:1,...z?{padding:0,margin:0,width:"100%",minHeight:"297mm",boxSizing:"border-box",display:"block"}:{padding:"32mm 15mm 20mm",height:"calc(297mm - 52mm)",minHeight:"calc(297mm - 52mm)",maxHeight:"calc(297mm - 52mm)",boxSizing:"border-box",display:"flex",flexDirection:"column",justifyContent:"flex-start"}},children:o||(t?u.jsx("div",{className:Tt(!z&&Tt("html-preview-container flex-1 flex flex-col",$e),z&&"w-full h-full"),style:z?{width:"100%",height:"100%"}:{display:"flex",flexDirection:"column",flex:1,width:"100%"},dangerouslySetInnerHTML:{__html:t}}):null)})]},d)});Ft.displayName="ProposalPreviewSheet";function to({isOpen:o,open:t,onClose:n,onOpenChange:g,formData:e,sections:i=[],customers:h=[],availableProducts:d=[],proposalSetting:_,totals:z,other_details:T,title:s,pageTitle:k,content:q,backgroundImage:b,settings:A,isDefaultPageSetup:Q,showPrintButton:R=!0,customHtml:Z=!1,inline:r=!1,autoPrint:j=!1,hideHeaderBar:$=!1}){const{t:p}=Ee(),y=!!(o??t);B.useEffect(()=>{var H;const l=(e==null?void 0:e.subject)||s||k||"",f=(e==null?void 0:e.customer_name)||(h&&h.length>0?(H=h[0])==null?void 0:H.name:"")||"",N=[l,f].filter(Boolean),a=N.length>0?N.join("_"):e!=null&&e.proposal_number?String(e.proposal_number):s||"";if(r&&a&&(document.title=a),r&&j){const C=setTimeout(()=>{a&&(document.title=a),window.print()},600);return()=>clearTimeout(C)}},[r,j,e,h,s,k]);const c=B.useCallback(()=>{n&&n(),g&&g(!1)},[n,g]);B.useRef(null);const w=B.useRef(null),x=_||A||null,G=(x==null?void 0:x.template_color)||ke,D=(x==null?void 0:x.show_logo)!==void 0?x.show_logo==="1"||x.show_logo===!0||x.show_logo===1||x.show_logo==="true":!0,dt=(x==null?void 0:x.logo_image)||(x==null?void 0:x.company_logo)||"",X=D&&dt?dt:"",V=(x==null?void 0:x.header_logo_align)||"right",S=(x==null?void 0:x.background_image)||"",E=!e&&(q!==void 0||s!==void 0||k!==void 0),nt=!!(Z||E&&q&&_e(q)),v=B.useMemo(()=>{if(!E)return"";const l=(q||"").trim();return!l&&(b||S)?"&nbsp;":l?fe(q,{settings:x,isDefaultPageSetup:Q??!0}):""},[E,q,b,S,x,Q]),[ct,mt]=B.useState([]),[$t,gt]=B.useState([]),[Lt,ut]=B.useState([]),[Mt,Ht]=B.useState([]);B.useEffect(()=>{if(!E)return;if(!v){mt([]);return}const l=()=>{if(nt){if(/class=["'][^"']*page-break[^"']*["']|style=["'][^"']*(?:page-break|break-after|break-before)[^"']*["']/i.test(v)&&w.current){const H=Yt(w.current,It());mt(H)}else mt([v]);return}if(w.current){const a=Yt(w.current,It());mt(a)}else mt([v])};let f=!1;return(async()=>{var a;(a=document.fonts)!=null&&a.ready&&await document.fonts.ready,f||l()})(),()=>{f=!0}},[E,v,y,r,nt]);const ht=B.useCallback(l=>{var f;if(l.product_name)return l.product_name;if(l.name)return l.name;if((f=l.product)!=null&&f.name)return l.product.name;if(l.product_id&&d.length>0){const N=d.find(a=>String(a.id)===String(l.product_id));if(N!=null&&N.name)return N.name}return l.product_description||l.description||p("Item / Service")},[d,p]),bt=B.useCallback(l=>{var f;if(l.product_description)return l.product_description;if(l.description)return l.description;if((f=l.product)!=null&&f.description)return l.product.description;if(l.product_id&&d.length>0){const N=d.find(a=>String(a.id)===String(l.product_id));if(N!=null&&N.description)return N.description}return""},[d]),xt=B.useCallback(l=>{var f,N,a,H;if(l.unit_name)return l.unit_name;if(l.unit&&isNaN(Number(l.unit)))return l.unit;if((N=(f=l.product)==null?void 0:f.unit_relation)!=null&&N.unit_name)return l.product.unit_relation.unit_name;if((a=l.product)!=null&&a.unit_name)return l.product.unit_name;if((H=l.product)!=null&&H.unit&&isNaN(Number(l.product.unit)))return l.product.unit;if(l.product_id&&d.length>0){const C=d.find(L=>String(L.id)===String(l.product_id));if(C!=null&&C.unit_name)return C.unit_name;if(C!=null&&C.unit&&isNaN(Number(C.unit)))return C.unit}return""},[d]),rt=B.useMemo(()=>(e==null?void 0:e.customer_mode)==="new"?{id:0,name:(e==null?void 0:e.customer_name)||"",email:(e==null?void 0:e.customer_email)||"",mobile_no:(e==null?void 0:e.customer_phone)||"",phone:(e==null?void 0:e.customer_phone)||"",address:(e==null?void 0:e.customer_address)||"",type:(e==null?void 0:e.customer_type)||"Individual"}:h.find(l=>String(l.id)===String(e==null?void 0:e.customer_id)),[h,e==null?void 0:e.customer_id,e==null?void 0:e.customer_mode,e==null?void 0:e.customer_name,e==null?void 0:e.customer_email,e==null?void 0:e.customer_phone,e==null?void 0:e.customer_address]),it=B.useMemo(()=>{if(E||!e)return"";const l=e.items||[],f=l.filter(m=>(m.section==="otc"||m.section==="general"||!m.section)&&(Number(m.product_id)>0||Number(m.unit_price)>0||!!m.product_description)),N=l.filter(m=>m.section==="mrc"&&(Number(m.product_id)>0||Number(m.unit_price)>0||!!m.product_description)),a=f.reduce((m,O)=>m+Number(O.quantity??1)*Number(O.unit_price||0),0);let H=0;if(e.otc_discount_value>0){const m=Number(e.otc_discount_value)||0;e.otc_discount_type==="percentage"?H=a*Math.min(Math.max(m,0),100)/100:H=Math.min(Math.max(m,0),a)}const C=f.reduce((m,O)=>m+Number(O.tax_amount||0),0),L=Math.max(0,a-H+C),P=N.reduce((m,O)=>m+Number(O.quantity??1)*Number(O.unit_price||0),0);let I=0;if(e.mrc_discount_value>0){const m=Number(e.mrc_discount_value)||0;e.mrc_discount_type==="percentage"?I=P*Math.min(Math.max(m,0),100)/100:I=Math.min(Math.max(m,0),P)}const F=N.reduce((m,O)=>m+Number(O.tax_amount||0),0),ft=Math.max(0,P-I+F),tt=[];i.forEach((m,O)=>{const st=(m.content||"").trim(),_t=(m.page_type||"").toLowerCase(),jt=_t==="otc"||st==="[OTC_CHARGES_TABLE]"||m.title&&m.title.toLowerCase().includes("one-time charges"),St=_t==="mrc"||st==="[MRC_CHARGES_TABLE]"||m.title&&m.title.toLowerCase().includes("monthly recurring charges"),Et=_t==="other-details"||st==="[OTHER_DETAILS_CONTENT]"||m.title&&m.title.toLowerCase().includes("other details");if(jt){if(f.length===0)return;const J=m.title||p("ONE-TIME CHARGES (OTC)");let et="";f.forEach((M,yt)=>{const lt=Number(M.quantity??1);xt(M);const at=Number(M.unit_price)||0,wt=M.total_amount!==void 0?Number(M.total_amount):lt*at,vt=bt(M),pt=Number(M.tax_amount)||0;et+=`
                        ...
                        <table class="charges-table w-full text-xs mb-2 border-collapse border border-slate-300" style="font-size: 11px; width: 100%; table-layout: fixed;">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right text-slate-900 font-semibold border border-slate-200" style="font-size: 10px; padding: 6px 8px !important;">+${W(C)}</td>
                                </tr>`:""}
                                <tr>
                                    <td colspan="5" class="border border-slate-200"></td>
                ...
                `);return}if(m.page_type==="custom"||!jt&&!St&&!Et){const J=m.background_image||"";(st||J)&&tt.push(`
...
`);return fe(Pt,{proposal:e,customer:rt,settings:x,isDefaultPageSetup:!1})},[E,e,i,h,ht,bt,xt,p,G,x,T]);B.useEffect(()=>{if(E||!it){gt(a=>a.length===0?a:[]),ut(a=>a.length===0?a:[]);return}const l=()=>{if(w.current){const a=Yt(w.current,It());gt(L=>L.length===a.length&&L.every((P,I)=>P===a[I])?L:a);const H=[],C=[];a.forEach(L=>{const P=L.match(/data-proposal-section-index=["'](\d+)["']/);if(P&&P[1]!==void 0){const I=parseInt(P[1],10),F=i[I];F!=null&&F.background_image&&F.background_image.trim()!==""?H.push(F.background_image):H.push(S);const ft=(F==null?void 0:F.content)||"",tt=_e(ft);C.push(tt);return}H.push(S),C.push(!1)}),ut(L=>L.length===H.length&&L.every((P,I)=>P===H[I])?L:H),Ht(L=>L.length===C.length&&L.every((P,I)=>P===C[I])?L:C)}else gt(a=>a.length===1&&a[0]===it?a:[it]),ut(a=>a.length===1&&a[0]===S?a:[S]),Ht(a=>a.length===1&&a[0]===!1?a:[!1])};let f=!1;return(async()=>{var a;(a=document.fonts)!=null&&a.ready&&await document.fonts.ready,f||l()})(),()=>{f=!0}},[E,it,i,S,y,r]);const At=B.useCallback(()=>{const l=(e==null?void 0:e.subject)||s||k||"",f=(rt==null?void 0:rt.name)||(e==null?void 0:e.customer_name)||"",N=[l,f].filter(Boolean),a=N.length>0?N.join("_"):e!=null&&e.proposal_number?String(e.proposal_number):document.title,H=document.title;a&&(document.title=a),window.print(),setTimeout(()=>{document.title=H},1e3)},[e,rt,s,k]),zt=s||k||(e==null?void 0:e.subject)||p("Preview"),Ct=()=>u.jsx("div",{className:"flex flex-col gap-6 items-center w-full print:gap-0 print:block",children:E?ct.length>0?ct.map((l,f)=>u.jsx(Ft,{pageKey:`single-page-${f}`,backgroundImage:b,defaultBg:S,templateColor:G,headerLogo:X,headerLogoAlign:V,content:l,customHtml:nt},`single-page-${f}`)):u.jsx(Ft,{pageKey:"single-page-0",backgroundImage:b,defaultBg:S,templateColor:G,headerLogo:X,headerLogoAlign:V,content:v,customHtml:nt},"single-page-0"):$t.length>0?$t.map((l,f)=>u.jsx(Ft,{pageKey:`proposal-page-${f}`,backgroundImage:Lt[f]||S,defaultBg:S,templateColor:G,headerLogo:X,headerLogoAlign:V,content:l,customHtml:!!Mt[f]},`proposal-page-${f}`)):u.jsx("div",{className:"p-8 text-center text-slate-500",children:p("No pages configured in Page Order.")})});return u.jsxs(u.Fragment,{children:[u.jsx("div",{ref:w,className:Tt("html-preview-container",$e),style:{position:"fixed",left:"-9999px",top:0,width:"180mm",visibility:"hidden",pointerEvents:"none",zIndex:-1},dangerouslySetInnerHTML:{__html:E?v:it}}),r?u.jsxs("div",{className:Tt("min-h-screen bg-slate-100 dark:bg-slate-950 px-4 print:p-0 print:bg-white flex flex-col items-center",$?"py-0":"py-8"),children:[!$&&u.jsxs("div",{className:"w-full max-w-[210mm] mb-6 flex items-center justify-between bg-white dark:bg-slate-900 p-4 rounded-lg shadow-sm border border-slate-200 dark:border-slate-800 print:hidden",children:[u.jsxs("div",{className:"flex items-center gap-3",children:[u.jsx("div",{className:"p-2 rounded-lg bg-primary/10 text-primary",children:u.jsx(Le,{className:"h-5 w-5"})}),u.jsxs("div",{children:[u.jsx("h1",{className:"font-bold text-slate-900 dark:text-slate-100 text-base",children:(e==null?void 0:e.proposal_number)||zt}),(e==null?void 0:e.subject)&&u.jsx("p",{className:"text-xs text-slate-500",children:e.subject})]})]}),u.jsx("div",{className:"flex items-center gap-2",children:u.jsxs(he,{variant:"default",size:"sm",onClick:()=>window.print(),className:"gap-2",children:[u.jsx(xe,{className:"h-4 w-4"}),p("Print / Save PDF")]})})]}),u.jsxs("div",{className:"w-full flex justify-center",children:[u.jsx("style",{dangerouslySetInnerHTML:{__html:ye}}),Ct()]})]}):u.jsx(ze,{open:y,onOpenChange:l=>!l&&c(),children:u.jsxs(Ce,{className:"max-w-4xl max-h-[92vh] flex flex-col p-0 gap-0 overflow-hidden bg-background border-border shadow-xl !rounded-md [&>div]:p-0 [&>div]:max-h-[92vh] [&>div]:flex [&>div]:flex-col [&>button]:top-2.5 [&>button]:right-3",children:[u.jsxs(je,{className:"!py-3 !px-5 bg-background border-b border-border flex flex-row items-center justify-between space-y-0 shrink-0",children:[u.jsxs("div",{className:"flex items-center gap-2.5 pr-8",children:[u.jsx("div",{className:"p-1.5 rounded-md bg-primary/10 text-primary",children:u.jsx(Me,{className:"h-4 w-4"})}),u.jsx(Se,{className:"text-sm font-semibold",children:zt})]}),R&&u.jsx("div",{className:"flex items-center gap-2 pr-6",children:u.jsxs(he,{variant:"default",size:"sm",onClick:At,className:"gap-2 text-xs h-8",children:[u.jsx(xe,{className:"h-3.5 w-3.5"}),p("Print")]})})]}),u.jsxs("div",{className:"flex-1 overflow-y-auto p-3 sm:p-5 bg-slate-100/70 dark:bg-slate-900 flex justify-center scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-slate-700 scrollbar-track-transparent",children:[u.jsx("style",{dangerouslySetInnerHTML:{__html:ye}}),Ct()]})]})})]})}export{$e as P,ye as a,Ft as b,to as c,De as d,Yt as p,fe as r};
