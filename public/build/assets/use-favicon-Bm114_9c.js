import{R as V,r as L,j as q}from"./ui-Ce3CDfXD.js";import{X as A}from"./app-B0HAGp6I.js";import{b as B}from"./helpers-Bf9P0TUC.js";const I=L.createContext(void 0);function N({children:d}){var $,z;const{adminAllSetting:x,companyAllSetting:C,auth:r}=A().props,E=(z=($=r==null?void 0:r.user)==null?void 0:$.roles)==null?void 0:z.includes("superadmin");let e;E!=null?e=E?x:C:e=x;const v=V.useMemo(()=>{if(r!=null&&r.layout_direction)return r.layout_direction;const o=document.documentElement.lang||"en";return["ar","he","ur","fa","ps","yi"].includes(o)?"rtl":"ltr"},[r==null?void 0:r.layout_direction]),t={logo_dark:(e==null?void 0:e.logo_dark)||"",logo_light:(e==null?void 0:e.logo_light)||"",favicon:(e==null?void 0:e.favicon)||"",titleText:(e==null?void 0:e.titleText)||"AutomasERP",footerText:(e==null?void 0:e.footerText)||"© AutomasERP. All rights reserved.",sidebarVariant:(e==null?void 0:e.sidebarVariant)||"inset",sidebarStyle:(e==null?void 0:e.sidebarStyle)||"plain",sidebarTextColor:(e==null?void 0:e.sidebarTextColor)||"#ffffff",themeMode:(e==null?void 0:e.themeMode)||"light",themeColor:(e==null?void 0:e.themeColor)||"green",customColor:(e==null?void 0:e.customColor)||"#10b981",layoutDirection:v},s=o=>B(o),i={blue:"#3b82f6",green:"#10b981",purple:"#8b5cf6",orange:"#f97316",red:"#ef4444"},c=()=>t.themeColor==="custom"?t.customColor||"#10b981":i[t.themeColor]||"#10b981";L.useEffect(()=>{const o=c(),n=document.documentElement,w=a=>{const p=parseInt(a.slice(1,3),16)/255,m=parseInt(a.slice(3,5),16)/255,b=parseInt(a.slice(5,7),16)/255,f=Math.max(p,m,b),g=Math.min(p,m,b);let y=0,P=0,_=(f+g)/2;if(f!==g){const k=f-g;switch(P=_>.5?k/(2-f-g):k/(f+g),f){case p:y=(m-b)/k+(m<b?6:0);break;case m:y=(b-p)/k+2;break;case b:y=(p-m)/k+4;break}y/=6}return`${Math.round(y*360)} ${Math.round(P*100)}% ${Math.round(_*100)}%`};n.style.setProperty("--primary",w(o)),n.style.setProperty("--primary-foreground","0 0% 98%");const h=v==="rtl";n.dir=h?"rtl":"ltr",n.style.direction=h?"rtl":"ltr",document.body.dir=h?"rtl":"ltr",document.body.style.direction=h?"rtl":"ltr",h?(document.body.classList.add("rtl"),document.body.classList.remove("ltr")):(document.body.classList.add("ltr"),document.body.classList.remove("rtl"));const M=t.themeMode,D=window.matchMedia("(prefers-color-scheme: dark)").matches;M==="light"?(document.body.classList.remove("dark"),document.body.classList.add("light")):M==="dark"?(document.body.classList.remove("light"),document.body.classList.add("dark")):M==="system"&&(D?(document.body.classList.remove("light"),document.body.classList.add("dark")):(document.body.classList.remove("dark"),document.body.classList.add("light")));let u=document.getElementById("brand-sidebar-styles");if(u||(u=document.createElement("style"),u.id="brand-sidebar-styles",document.head.appendChild(u)),t.sidebarStyle==="colored"||t.sidebarStyle==="gradient"){const a=t.sidebarTextColor||"#ffffff";u.textContent=`
    [data-sidebar] {
