...
interface CookieConsentProps {
  settings: {
    ...
    enableLogging?: boolean | string | number;
    strictlyNecessaryCookies?: boolean | string | number;
    cookieTitle?: string;
...
export default function CookieConsent({ settings }: CookieConsentProps) {
  ...
  const saveConsent = (consent: any) => {
    try {
      ...
      const isLoggingEnabled = settings.enableLogging === true || settings.enableLogging === '1' || settings.enableLogging === 1;
      if (isLoggingEnabled) {
