...
export default function Edit({ settings, defaultPage, variables }: EditProps) {
    ...
    // Detect if content has raw/custom HTML code (div, table, section, style, iframe, custom classes/styles)
                        ...
                        <CardContent className="space-y-6 p-4 sm:p-6">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    {/* 3. Exact A4 HTML & CSS Live Editable Preview (Scrollable internally with max-height) */}
                                    {editorMode === 'preview' && (
                                        <div
