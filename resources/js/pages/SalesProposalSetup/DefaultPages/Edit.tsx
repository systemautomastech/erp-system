...
interface EditProps {
    ...
    defaultPage: ProposalDefaultPageItem;
...
export default function Edit({ settings, defaultPage }: EditProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('proposal-setup.default-pages.update', defaultPage.id), {
            onSuccess: () => {
                                            ...
                                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-xs text-muted-foreground">
                                                        {useCustomBg ? t('Custom Image') : t('Proposal Default Background')}
                                                    </span>
                                                    {!useCustomBg && (
                                                        <a
