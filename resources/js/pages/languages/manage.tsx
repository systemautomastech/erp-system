...
export default function LanguageManage({
    ...
    // Use static languagesData instead of filtered availableLanguages for the dropdown
    const allLanguages: Language[] = languagesData
        .map((lang: Language) => ({
            ...lang,
            flag: getCountryFlag(lang.countryCode)
        }));

    // Use availableLanguages from props for other logic
