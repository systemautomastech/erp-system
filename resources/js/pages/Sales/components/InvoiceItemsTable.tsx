...
export default function InvoiceItemsTable({ items, onChange, errors = {}, products = [], showAddButton = true, invoiceType = 'product', onRefresh, isRefreshing = false, isTaxEnabled = true }: Props) {
                ...
                <table className="min-w-full">
                    ...
                    <tbody className="divide-y divide-border">
                        {items.map((item, index) => {
                            // Extract distinct types that exist in the available products list
                            ...
                            // If no products loaded yet, provide standard product/service fallback
