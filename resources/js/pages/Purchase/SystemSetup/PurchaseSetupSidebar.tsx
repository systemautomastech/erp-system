...
interface PurchaseSetupSidebarProps {
    activeItem?: string;
    onSectionChange?: (section: string) => void;
}

export default function PurchaseSetupSidebar({ activeItem, onSectionChange }: PurchaseSetupSidebarProps) {
    ...
    const sidebarItems: SidebarItem[] = [
        {
            key: 'purchase-invoice-settings',
            label: t('Purchase Invoice Setup'),
            icon: FileText,
            route: 'purchase-invoice-setup.index',
