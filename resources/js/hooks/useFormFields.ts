...
export const useFormFields = (hookName: string, data: any, setData: any, errors: any, mode: string = 'create', ...additionalParams: any[]): FormField[] => {
    try {
        ...
        const allModules = import.meta.glob('../../../packages/automas/*/src/Resources/js/fields/fields.tsx', { eager: true });

        const fields: FormField[] = [];

        activatedPackages.forEach((packageName: string) => {
            const fieldPath = `../../../packages/automas/${packageName}/src/Resources/js/fields/fields.tsx`;
