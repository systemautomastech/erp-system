...
export default function Index() {
    ...
    useFlashMessages();
    const dropboxBtn = usePageButtons('dropboxBtn', { module: 'BalanceSheet', settingKey: 'Dropbox BalanceSheet' });
    const boxBtn = usePageButtons('boxBtn', { module: 'BalanceSheet', settingKey: 'Box BalanceSheet' });
