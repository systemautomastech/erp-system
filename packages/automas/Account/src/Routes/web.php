...
use Automas\Account\Http\Controllers\RevenueCategoriesController;
use Automas\Account\Http\Controllers\ExpenseCategoriesController;

use Automas\Account\Http\Controllers\ChartOfAccountController;

use Automas\Account\Http\Controllers\BankAccountController;

use Illuminate\Support\Facades\Route;
use Automas\Account\Http\Controllers\AccountTypeController;
use Automas\Account\Http\Controllers\DashboardController;
use Automas\Account\Http\Controllers\SystemSetupController;
use Automas\Account\Http\Controllers\VendorController;
use Automas\Account\Http\Controllers\CustomerController;
use Automas\Account\Http\Controllers\VendorPaymentController;
use Automas\Account\Http\Controllers\BankTransactionController;
use Automas\Account\Http\Controllers\BankTransferController;
use Automas\Account\Http\Controllers\DebitNoteController;
use Automas\Account\Http\Controllers\CreditNoteController;
use Automas\Account\Http\Controllers\CustomerPaymentController;
use Automas\Account\Http\Controllers\RevenueController;
use Automas\Account\Http\Controllers\ExpenseController;
use Automas\Account\Http\Controllers\ReportsController;
