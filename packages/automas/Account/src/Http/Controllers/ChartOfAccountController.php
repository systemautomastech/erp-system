...
use Automas\Account\Http\Requests\StoreChartOfAccountRequest;
use Automas\Account\Http\Requests\UpdateChartOfAccountRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Automas\Account\Events\CreateChartOfAccount;
use Automas\Account\Events\DestroyChartOfAccount;
use Automas\Account\Events\UpdateChartOfAccount;
