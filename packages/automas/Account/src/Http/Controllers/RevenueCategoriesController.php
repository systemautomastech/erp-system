...
use Automas\Account\Http\Requests\StoreRevenueCategoriesRequest;
use Automas\Account\Http\Requests\UpdateRevenueCategoriesRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Automas\Account\Events\CreateRevenueCategories;
use Automas\Account\Events\DestroyRevenueCategories;
use Automas\Account\Events\UpdateRevenueCategories;
