...
use Automas\Account\Http\Requests\StoreAccountTypeRequest;
use Automas\Account\Http\Requests\UpdateAccountTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Automas\Account\Events\CreateAccountType;
use Automas\Account\Events\DestroyAccountType;
use Automas\Account\Events\UpdateAccountType;
use Automas\Account\Models\AccountCategory;
