...
interface EditProps {
    settings?: { template_color?: string; background_image?: string; logo_image?: string; company_logo?: string; show_logo?: any; header_logo_align?: string; [key: string]: any } | null;
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-12 gap-6 items-start">
                {/* Left Column: Grouped Variables or Fixed Page Info */}
                <div className="col-span-12 lg:col-span-3 lg:sticky lg:top-4 space-y-4">
                    {isFixedPage ? (
                        <Card className="border-amber-500/30 bg-amber-500/[0.03] shadow-xs">
                            <CardHeader className="p-3.5 pb-2.5 border-b border-amber-500/20">
                                <CardTitle className="text-xs font-semibold uppercase tracking-wider flex items-center gap-1.5 text-amber-700 dark:text-amber-300">
                                    <Info className="h-4 w-4 text-amber-600 shrink-0" />
                                    {t('System Fixed Page')}
                                </CardTitle>
                            </CardHeader>
                            <CardContent className="p-3.5 space-y-3 text-xs text-muted-foreground leading-relaxed">
                                <p>
                ...
                <div className="col-span-12 lg:col-span-9 space-y-6">
                    <Card className="border-border/70 shadow-xs">
                        <CardContent className="p-5 sm:p-6">
                            <form id="edit-default-page-form" onSubmit={handleSubmit} className="space-y-5">
