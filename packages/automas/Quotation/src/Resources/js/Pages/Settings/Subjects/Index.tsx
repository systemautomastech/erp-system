...
export default function Subjects({ subjects = [] }: QuotationSubjectsProps) {
    ...
    const handleNavClick = (id: string) => {
        if (id !== 'subjects') {
            router.get(route('quotation-setup.index'));
        }
    };
    ...
    const tableColumns = [
        ...
        },
        {
            key: 'actions',
            header: t('Action'),
            render: (_: any, subject: QuotationSubjectItem) => (
        ...
        <TooltipProvider>
            <AuthenticatedLayout
                breadcrumbs={[
                    ...
                    { label: t('System Setup'), url: route('quotation-setup.index') },
                    { label: t('Subjects') },
                ]}
                pageTitle={t('System Setup')}
            >
                <Head title={t('Quotation Subjects')} />
