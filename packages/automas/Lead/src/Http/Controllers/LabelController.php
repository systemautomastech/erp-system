...
use Automas\Lead\Http\Requests\StoreLabelRequest;
use Automas\Lead\Http\Requests\UpdateLabelRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Automas\Lead\Models\Pipeline;
use Automas\Lead\Events\CreateLabel;
use Automas\Lead\Events\UpdateLabel;
use Automas\Lead\Events\DestroyLabel;
