...
export default function Activity({ deal }: ActivityProps) {
    ...
    const getActivityIcon = (logType: string = '', remark: string = '') => {
        ...
        if (text.includes('client')) return <UserCheck className="h-4 w-4 text-teal-600" />;
        ...
        if (text.includes('price') || text.includes('amount')) return <DollarSign className="h-4 w-4 text-emerald-600" />;
        if (text.includes('create deal') || text.includes('create')) return <Briefcase className="h-4 w-4 text-primary" />;
    ...
    const getActivityBg = (logType: string = '', remark: string = '') => {
        ...
        if (text.includes('client')) return 'bg-teal-50 border-teal-100';
        ...
        if (text.includes('price') || text.includes('amount')) return 'bg-emerald-50 border-emerald-100';
