...
import { CheckSquare, Mail, Phone, Users, MessageSquare, Upload, Activity as ActivityIcon } from 'lucide-react';
                                ...
                                <div className="flex-shrink-0">
                                    <div className="w-8 h-8 bg-primary/10 rounded-full flex items-center justify-center">
                                        {(() => {
                                            ...
                                            if (remark.includes('file') || remark.includes('File') || remark.includes('upload') || remark.includes('Upload')) return <Upload className="h-4 w-4 text-primary" />;
