...
import { EditEmployeeTransferProps, EditEmployeeTransferFormData } from './types';
...
export default function EditEmployeeTransfer({ employeetransfer, onSuccess }: EditEmployeeTransferProps) {
    ...
    const { data, setData, put, processing, errors } = useForm<EditEmployeeTransferFormData>({
        employee_id: employeetransfer.employee_id?.toString() || '',
        to_branch_id: employeetransfer.to_branch_id?.toString() || '',
        to_department_id: employeetransfer.to_department_id?.toString() || '',
        to_designation_id: employeetransfer.to_designation_id?.toString() || '',
        effective_date: employeetransfer.effective_date || '',
        reason: employeetransfer.reason ?? '',
        document: employeetransfer.document || '',
    });
    ...
    return (
        <DialogContent>
            <DialogHeader>
                <DialogTitle>{t('Edit Employee Transfer')}</DialogTitle>
            </DialogHeader>
