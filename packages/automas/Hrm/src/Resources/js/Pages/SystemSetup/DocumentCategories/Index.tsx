...
export default function Index() {
    ...
    const { deleteState, openDeleteDialog, closeDeleteDialog, confirmDelete } = useDeleteHandler({
        ...
        defaultMessage: t('Are you sure you want to delete this Document Category?')
    });
        ...
        <TooltipProvider>
            ...
            >
                                    ...
                                    <div className="min-w-[600px]">
                                        <DataTable
                                            ...
                                            emptyState={
                                                <NoRecordsFound
                                                    icon={FileText}
                                                    title={t('No Document Categories found')}
                                                    description={t('Get started by creating your first Document Category.')}
                                                    createPermission="create-document-categories"
                                                    onCreateClick={() => openModal('add')}
                                                    createButtonText={t('Create Document Category')}
                                                    className="h-auto"
                                                />
                                            }
                                        />
                ...
                <ConfirmationDialog
                    ...
                    title={t('Delete Document Category')}
