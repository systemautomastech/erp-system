...
export default function Index() {
    ...
    const { deleteState, openDeleteDialog, closeDeleteDialog, confirmDelete } = useDeleteHandler({
        ...
        defaultMessage: t('Are you sure you want to delete this Loan Type?')
    });
                        ...
                        {auth.user?.permissions?.includes('edit-loan-types') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => openModal('edit', loantype)} className="h-8 w-8 p-0 text-blue-600 hover:text-blue-700">
