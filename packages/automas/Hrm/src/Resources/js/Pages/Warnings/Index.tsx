    ...
    const tableColumns = [
        ...
        },
        {
            ...
            render: (value: string) => {
                ...
                return (
                    <span className={`px-2 py-1 rounded-full text-sm font-medium ${severityColors[value as keyof typeof severityColors] || 'bg-gray-100 text-gray-800'}`}>
                        {t(value || '-')}
                    </span>
                );
            }
            ...
            render: (_: any, warning: Warning) => (
                <div className="flex gap-1">
                    <TooltipProvider>
                            ...
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" asChild className="h-8 w-8 p-0 text-orange-600 hover:text-orange-700">
                                        <a href={getImagePath(warning.document)} target="_blank" rel="noopener noreferrer">
                        ...
                        {warning.status === 'pending'  && auth.user?.permissions?.includes('manage-warning-response') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                            ...
                                            <div className="p-4 bg-gradient-to-r from-primary/5 to-transparent border-b flex-shrink-0">
                                                <div className="flex items-center gap-3">
                                                    <div className="p-2 bg-primary/10 rounded-lg">
                                                        <AlertOctagonIcon className="h-5 w-5 text-primary" />
                                                    </div>
                                                    <div className="min-w-0 flex-1">
                                                        <h3 className="font-semibold text-sm text-gray-900 break-words">{warning.subject}</h3>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="grid grid-cols-1 gap-4">
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="text-xs min-w-0">
                                                            ...
                                                            <p className="font-medium text-xs">{warning.employee?.name || '-'}</p>
                                                        </div>
                                                        <div className="text-xs min-w-0">
