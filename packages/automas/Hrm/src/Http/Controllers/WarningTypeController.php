...
use Automas\Hrm\Http\Requests\StoreWarningTypeRequest;
use Automas\Hrm\Http\Requests\UpdateWarningTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Automas\Hrm\Events\CreateWarningType;
use Automas\Hrm\Events\DestroyWarningType;
use Automas\Hrm\Events\UpdateWarningType;
