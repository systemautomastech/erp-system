...
use Automas\Hrm\Http\Requests\StoreShiftRequest;
use Automas\Hrm\Http\Requests\UpdateShiftRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use App\Models\User;
use Automas\Hrm\Events\CreateShift;
use Automas\Hrm\Events\UpdateShift;
use Automas\Hrm\Events\DestroyShift;
