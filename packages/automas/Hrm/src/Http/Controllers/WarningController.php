...
use Automas\Hrm\Http\Requests\StoreWarningRequest;
use Automas\Hrm\Http\Requests\UpdateWarningRequest;
...
use Automas\Hrm\Events\CreateWarning;
use Automas\Hrm\Events\DestroyWarning;
use Automas\Hrm\Events\UpdateWarning;
