...
use Automas\Hrm\Http\Requests\StoreHolidayTypeRequest;
use Automas\Hrm\Http\Requests\UpdateHolidayTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Automas\Hrm\Events\CreateHolidayType;
use Automas\Hrm\Events\DestroyHolidayType;
use Automas\Hrm\Events\UpdateHolidayType;
