...
use Automas\Hrm\Http\Requests\StoreTerminationTypeRequest;
use Automas\Hrm\Http\Requests\UpdateTerminationTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Automas\Hrm\Events\CreateTerminationType;
use Automas\Hrm\Events\DestroyTerminationType;
use Automas\Hrm\Events\UpdateTerminationType;
