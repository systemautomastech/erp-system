...
use Automas\Hrm\Http\Requests\StoreLeaveTypeRequest;
use Automas\Hrm\Http\Requests\UpdateLeaveTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Automas\Hrm\Events\CreateLeaveType;
use Automas\Hrm\Events\DestroyLeaveType;
use Automas\Hrm\Events\UpdateLeaveType;
