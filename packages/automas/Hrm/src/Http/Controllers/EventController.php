...
use Automas\Hrm\Http\Requests\StoreEventRequest;
use Automas\Hrm\Http\Requests\UpdateEventRequest;
...
use Automas\Hrm\Events\CreateEvent;
use Automas\Hrm\Events\DestroyEvent;
use Automas\Hrm\Events\UpdateEvent;
