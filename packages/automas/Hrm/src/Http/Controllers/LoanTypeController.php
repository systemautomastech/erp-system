...
use Automas\Hrm\Http\Requests\StoreLoanTypeRequest;
use Automas\Hrm\Http\Requests\UpdateLoanTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Automas\Hrm\Events\CreateLoanType;
use Automas\Hrm\Events\DestroyLoanType;
use Automas\Hrm\Events\UpdateLoanType;
