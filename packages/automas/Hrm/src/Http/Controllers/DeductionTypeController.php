...
use Automas\Hrm\Http\Requests\StoreDeductionTypeRequest;
use Automas\Hrm\Http\Requests\UpdateDeductionTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Automas\Hrm\Events\CreateDeductionType;
use Automas\Hrm\Events\DestroyDeductionType;
use Automas\Hrm\Events\UpdateDeductionType;
