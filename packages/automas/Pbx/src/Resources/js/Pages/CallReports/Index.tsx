                        ...
                        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={setExtensionFilter}
                                >
                                    <SelectTrigger>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="overflow-x-auto">
                            <Table className="w-full min-w-[1100px] text-sm border-separate border-spacing-y-3">
                                <TableHeader>
                                ...
                                <TableBody>
                                    {filteredCalls.length === 0 ? (
                                        ...
                                        filteredCalls.map((call) => (
                                            <TableRow
                                                key={`${call.linkedid}-${call.extension}-${call.direction}`}
