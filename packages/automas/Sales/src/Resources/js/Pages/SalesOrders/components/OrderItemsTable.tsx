...
export default function OrderItemsTable({ items, onChange, errors, products, showAddButton = true }: OrderItemsTableProps) {
                ...
                <table className="min-w-full">
                    ...
                    <tbody className="divide-y divide-border">
                        {items.map((item, index) => (
                            <tr key={`item-${index}-${item.product_id}`}>
                                ...
                                <td className="px-4 py-4">
                                    <span className="text-sm font-medium">
                                        {formatCurrency(item.total_amount, props)}
                                    </span>
                                </td>
