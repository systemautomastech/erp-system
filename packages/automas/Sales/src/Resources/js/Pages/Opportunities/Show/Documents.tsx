...
export default function Documents({ opportunity, onRegisterAddHandler }: DocumentsProps) {
    const { t } = useTranslation();
    const pageProps = usePage().props as any;
    const { documents, users, accounts, folders, types, auth, allOpportunities } = pageProps;
