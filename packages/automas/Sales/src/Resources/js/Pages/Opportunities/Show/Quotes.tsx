...
export default function Quotes({ opportunity, onRegisterAddHandler }: QuotesProps) {
    ...
    useEffect(() => {
        onRegisterAddHandler(() => {
            router.post(route('sales.quotes.create.context'), { 
                from_opportunity: opportunity.id, 
                from_account: opportunity.account_id 
            });
        });
    }, [onRegisterAddHandler, opportunity.id, opportunity.account_id]);
                    ...
                    <DataTable
                        ...
                        emptyState={
                            <NoRecordsFound
                                ...
                                onCreateClick={() => router.post(route('sales.quotes.create.context'), { 
                                    from_opportunity: opportunity.id, 
                                    from_account: opportunity.account_id 
                                })}
