...
export default function Cases({ contact, onRegisterAddHandler }: CasesProps) {
    const { t } = useTranslation();
    const pageProps = usePage().props as any;
    const { cases, users, accounts, contacts, caseTypes, auth } = pageProps;
            ...
            <Dialog open={caseModal.isOpen} onOpenChange={closeCaseModal}>
                {caseModal.mode === 'add' && (
                    <CreateCase
                        ...
                        contacts={contacts || []}
                        caseTypes={caseTypes || []}
                        defaultAccountId={contact.account_id}
