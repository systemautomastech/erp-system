...
export default function SalesOrders({ account, onRegisterAddHandler }: SalesOrdersProps) {
    ...
    useEffect(() => {
        if (auth.user?.permissions?.includes('create-sales-orders')) {
            onRegisterAddHandler(() => {
                router.post(route('sales.orders.create.context'), { from_account: account.id });
            });
        }
                    ...
                    <DataTable
                        ...
                        emptyState={
                            <NoRecordsFound
                                ...
                                onCreateClick={() => router.post(route('sales.orders.create.context'), { from_account: account.id })}
