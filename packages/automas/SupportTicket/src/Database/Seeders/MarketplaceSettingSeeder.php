        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/automas/SupportTicket/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'SupportTicket'], [
            ...
            'config_sections' => [
                'sections' => [
                    'hero' => [
                        'variant' => 'hero1',
                        'title' => 'SupportTicket Module for Automas ERP',
                        ...
                        'image' => '/packages/automas/SupportTicket/src/marketplace/hero.png'
                    ],
                    'modules' => [
                        'variant' => 'modules1',
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot' => '/packages/automas/SupportTicket/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/automas/SupportTicket/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/automas/SupportTicket/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [
