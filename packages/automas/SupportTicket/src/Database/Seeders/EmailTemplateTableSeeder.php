...
class EmailTemplateTableSeeder extends Seeder
{
    public function run(): void
    {
        ...
        if (!$admin) {
            throw new \Exception('No company user found. Please create a company user before running this seeder.');
        }
                        ...
                        'New Ticket' => [
                                ...
                                'variables' => '{
                                  ...
                                  'lang' => [
                                        ...
                                        'pt-BR' => '<p>Olá,<br />Bem-vindo à {app_name}</p><p><strong>Email</strong>: {email}</p><p><strong>ID do ticket</strong>: {ticket_id}</p><p style="text-align: center;" align="center"><span style="font-size: 18pt;"><a href="{ticket_url}" target="_blank" rel="noopener" style="background: #6676ef; color: #ffffff; font-family: Open Sans, Helvetica, Arial, sans-serif; font-weight: bold; line-height: 120%; margin: 0px; text-decoration: none; text-transform: none; padding: 10px 20px; border-radius: 5px; display: inline-block;"><strong style="color: white; font-weight: bold;">Confira o seu ticket</strong></a></span></p><p>{app_url}</p><p>Obrigado,<br />{app_name}</p>',
                                        'he' => '<p>שלום,<br />ברוכים הבאים ל-{app_name}</p><p><strong>אימייל</strong>: {email}</p><p><strong>מזהה כרטיס</strong>: {ticket_id}</p><p style="text-align: center;" align="center"><span style="font-size: 18pt;"><a href="{ticket_url}" target="_blank" rel="noopener" style="background: #6676ef; color: #ffffff; font-family: Open Sans, Helvetica, Arial, sans-serif; font-weight: bold; line-height: 120%; margin: 0px; text-decoration: none; text-transform: none; padding: 10px 20px; border-radius: 5px; display: inline-block;"><strong style="color: white; font-weight: bold;">בדוק את הכרטיס שלך</strong></a></span></p><p>{app_url}</p><p>תודה,<br />{app_name}</p>',
                                        'zh' => '<p>您好，<br />欢迎来到 {app_name}</p><p><strong>邮箱</strong>: {email}</p><p><strong>工单ID</strong>: {ticket_id}</p><p style="text-align: center;" align="center"><span style="font-size: 18pt;"><a href="{ticket_url}" target="_blank" rel="noopener" style="background: #6676ef; color: #ffffff; font-family: Open Sans, Helvetica, Arial, sans-serif; font-weight: bold; line-height: 120%; margin: 0px; text-decoration: none; text-transform: none; padding: 10px 20px; border-radius: 5px; display: inline-block;"><strong style="color: white; font-weight: bold;">查看您的工单</strong></a></span></p><p>{app_url}</p><p>谢谢，<br />{app_name}</p>',
                                ],
                            ],
                            'New Ticket Reply' => [
                                ...
                                'lang' => [
                                    ...
                                    'de' => '<p>Hallo, Willkommen bei {app_name}.</p><p>&nbsp;</p><p>{ticket_name}</p><p>{ticket_id}</p><p>&nbsp;</p><p>Beschreibung: {reply_description}</p><p>&nbsp;</p><p>Danke,</p><p>{app_name}</p>',
                                    ...
                                    'fr' => '<p>Bonjour, Bienvenue dans {app_name}.</p><p>&nbsp;</p><p>{ticket_name}</p><p>{ticket_id}</p><p>&nbsp;</p><p>Description: {reply_description}</p><p>&nbsp;</p><p>Merci,</p><p>{app_name}</p>',
                                    ...
                                    'ru' => '<p>Здравствуйте, Добро пожаловать в {app_name}.</p><p>&nbsp;</p><p>{ticket_name}</p><p>{ticket_id}</p><p>&nbsp;</p><p>Описание: {reply_description}</p><p>&nbsp;</p><p>Спасибо,</p><p>{app_name}</p>',
                                    ...
                                    'tr' => '<p>Merhaba, {app_name}\'a hoş geldiniz.</p><p>&nbsp;</p><p>{ticket_name}</p><p>{ticket_id}</p><p>&nbsp;</p><p>Açıklama: {reply_description}</p><p>&nbsp;</p><p>Teşekkürler,</p><p>{app_name}</p>',
                                    'pt-BR' => '<p>Olá, Bem-vindo a {app_name}.</p><p>&nbsp;</p><p>{ticket_name}</p><p>{ticket_id}</p><p>&nbsp;</p><p>Descrição: {reply_description}</p><p>&nbsp;</p><p>Obrigado,</p><p>{app_name}</p>',
                                    'he' => '<p>שלום, ברוכים הבאים ל-{app_name}.</p><p>&nbsp;</p><p>{ticket_name}</p><p>{ticket_id}</p><p>&nbsp;</p><p>תיאור: {reply_description}</p><p>&nbsp;</p><p>תודה,</p><p>{app_name}</p>',
                                    'zh' => '<p>您好，欢迎来到 {app_name}。</p><p>&nbsp;</p><p>{ticket_name}</p><p>{ticket_id}</p><p>&nbsp;</p><p>描述：{reply_description}</p><p>&nbsp;</p><p>谢谢，</p><p>{app_name}</p>',
                                ],
                            ],
                ];
        foreach ($emailTemplate as $eTemp) {
            ...
            if (!$table) {
                $emailtemplate = EmailTemplate::create([
                    'name' => $eTemp,
                    'from' => config('app.name', 'Automas ERP'),
