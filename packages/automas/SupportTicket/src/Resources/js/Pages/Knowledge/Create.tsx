...
export default function Create({ categories, onSuccess, onCancel }: CreateKnowledgeProps) {
  ...
  const titleAI = useFormFields('aiField', data, setData, errors, 'create', 'title', 'Title', 'supportticket', 'knowledge');
  const [descriptionEditorKey, setDescriptionEditorKey] = useState(0);
  const descriptionAI = useFormFields('aiField', data, (field, value) => {
    setData(field, value);
    setDescriptionEditorKey(prev => prev + 1);
  }, errors, 'create', 'description', 'Description', 'supportticket', 'knowledge');
