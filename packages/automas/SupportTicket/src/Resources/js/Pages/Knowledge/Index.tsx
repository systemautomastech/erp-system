...
import { Plus, Edit, Trash2, Upload, Download, BookOpen } from 'lucide-react';
...
export default function Index({ knowledge, categories }: Props) {
  ...
  const googleDriveButtons = usePageButtons('googleDriveBtn', { module: 'Knowledge', settingKey: 'GoogleDrive Knowledge' });
  const oneDriveButtons = usePageButtons('oneDriveBtn', { module: 'Knowledge', settingKey: 'OneDrive Knowledge' });
  const dropboxBtn = usePageButtons('dropboxBtn', { module: 'Knowledge', settingKey: 'Dropbox Knowledge' });
  const boxBtn = usePageButtons('boxBtn', { module: 'Knowledge', settingKey: 'Box Knowledge' });
  ...
  return (
    ...
    >
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                />
                {(() => {
                  const activeFilters = [filters.category_id].filter(f => f !== '' && f !== null && f !== undefined).length;
            ...
            <DataTable
                ...
                emptyState={
                  <NoRecordsFound
                    ...
                    hasFilters={!!(filters.title || filters.category_id)}
      ...
      <Dialog open={showCreateModal} onOpenChange={setShowCreateModal}>
        <Create categories={categories} onSuccess={handleCreateSuccess} onCancel={handleCreateCancel} />
      </Dialog>
