    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Original Ticket */}
          <Card key={ticket.id} className={ticket.user_id === 'admin' ? 'border-l-4 border-l-green-500' : 'border-l-4 border-l-blue-500'}>
          ...
          {conversations && conversations.map((conversion) => (
            <Card key={conversion.id} className={conversion.sender === 'admin' ? 'border-l-4 border-l-green-500' : 'border-l-4 border-l-blue-500'}>
              <CardHeader className="pb-3">
                <div className="flex items-center gap-3">
                  <Avatar className="h-10 w-10">
                    <AvatarFallback className={conversion.sender === 'admin' ? 'bg-green-500 text-white' : 'bg-blue-500 text-white'}>
