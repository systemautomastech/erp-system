...
import { TicketIcon, CheckCircleIcon, LinkIcon, BookOpenIcon, HelpCircleIcon, TruckIcon, Clock, TrendingUp, Users, Calendar, Eye, Copy } from 'lucide-react';
...
export default function VendorDashboard({ supportUrl, stats, monthlyData, recentTickets, statusData, slug }: VendorDashboardProps) {
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  {supportUrl && (
                    <Button className="bg-orange-600 hover:bg-orange-700" onClick={copyToClipboard}>
