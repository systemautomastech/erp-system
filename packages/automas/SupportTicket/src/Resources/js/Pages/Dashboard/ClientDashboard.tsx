...
import { TicketIcon, CheckCircleIcon, LinkIcon, BookOpenIcon, HelpCircleIcon, Clock, TrendingUp, Users, Calendar, Eye, Copy } from 'lucide-react';
...
export default function ClientDashboard({ supportUrl, stats, monthlyData, recentTickets, statusData, slug }: ClientDashboardProps) {
    ...
    >
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  {supportUrl && (
                    <Button className="bg-blue-600 hover:bg-blue-700" onClick={copyToClipboard}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-white shadow-lg rounded-2xl border-0 hover:shadow-xl transition-all duration-300 cursor-pointer" onClick={() => router.get(route('support-tickets.index'))}>
