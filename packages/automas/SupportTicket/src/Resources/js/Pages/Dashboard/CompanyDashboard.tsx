...
export default function Index({ supportUrl, stats, monthlyData, recentTickets, statusData, slug }: DashboardProps) {
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4">
          ...
          <Card className="bg-gradient-to-r from-red-50 to-red-100 border-red-200 cursor-pointer hover:shadow-lg transition-all duration-200" onClick={() => router.get(route('support-ticket.system-setup.ticket-category.index'))}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            {recentTickets && recentTickets.length > 0 ? (
              <div className="space-y-4">
                {recentTickets.map((ticket) => (
                  <div key={ticket.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer" onClick={() => router.get(route('support-tickets.show', ticket.id))}>
