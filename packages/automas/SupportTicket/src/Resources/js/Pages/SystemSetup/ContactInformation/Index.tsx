...
export default function ContactInformation({ contactInformation }: ContactInformationProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('support-ticket.system-setup.contact-information.store'), {
            onSuccess: () => {
                toast.success(t('Contact information updated successfully'));
            },
            onError: () => {
                toast.error(t('Failed to update contact information'));
            }
        });
    };
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <Textarea
                                                ...
                                                placeholder={t('https://www.google.com/maps/embed?pb=...')}
                                                rows={3}
                                            />
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <Textarea
                                                    ...
                                                    placeholder={t('350 Fifth Avenue, New York, NY 10118')}
                                                    rows={3}
                                                />
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <Input
                                                        ...
                                                        placeholder={t('info@dashsupport.com')}
                                                    />
