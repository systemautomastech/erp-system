...
export default function EditCategory({ category, onSuccess }: EditProps) {
    ...
    const nameAI = useFormFields('aiField', data, setData, errors, 'edit', 'name', 'Category Name', 'supportticket', 'category');

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('support-ticket.system-setup.ticket-category.update', category.id), {
            onSuccess: () => onSuccess()
        });
    };
