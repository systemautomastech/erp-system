...
export default function BrandSettings() {
    ...
    const defaultImages = {
        logo_dark: getImagePath('/packages/automas/SupportTicket/src/Resources/assets/images/logo.png'),
        favicon: getImagePath('/packages/automas/SupportTicket/src/Resources/assets/images/favicon.png')
    };
    ...
    const saveSettings = () => {
        ...
        router.post(route('support-ticket.system-setup.brand-settings.store'), {
