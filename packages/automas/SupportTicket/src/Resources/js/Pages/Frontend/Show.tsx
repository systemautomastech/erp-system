...
export default function Show({ ticket, settings, brandSettings }: ShowProps) {
    const { t } = useTranslation();
    const pageProps = usePage().props;
    const { imageUrlPrefix, userSlug } = pageProps as any;
                    ...
                    <div className="space-y-6 mb-6">
                        <div className="flex gap-4">
                            <div className="flex-shrink-0">
                                <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-semibold">
                                                ...
                                                <div key={index} className="flex items-center justify-between">
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            ...
                                                            link.href = `${imageUrlPrefix}/${attachment.path}`;
                            ...
                            <div key={conversion.id} className="flex gap-4">
                                <div className="flex-shrink-0">
                                    <div className={`w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center text-white font-semibold ${
                                        conversion.sender === 'admin' ? 'bg-green-500' : 'bg-blue-500'
                                    }`}>
                                ...
                                <div className="flex-grow">
                                    ...
                                    <div className={`rounded-xl p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-md ${conversion.sender === 'admin' ? 'bg-green-50 border-l-4 border-green-400' : 'bg-blue-50 border-l-4 border-blue-400'
                                        }`}>
