...
export default function SearchTicket() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('support-ticket.search.post', [userSlug]), data);
    };
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-10 pr-4 py-3 bg-white/10 border border-blue-300/30 text-white placeholder-white rounded-lg focus:outline-none focus:ring-2 focus:ring-white"
                                                required
                                            />
