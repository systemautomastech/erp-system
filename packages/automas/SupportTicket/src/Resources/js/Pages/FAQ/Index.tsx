...
import { Plus, Edit, Trash2, Upload, Download, HelpCircle } from 'lucide-react';
...
export default function Index({ faqs }: Props) {
  ...
  const clearFilters = () => {
    setFilters({ search: '' });
    router.get(route('support-ticket-faq.index'), {per_page: perPage});
  };
  ...
  return (
    ...
    >
      ...
      <Dialog open={showCreateModal} onOpenChange={setShowCreateModal}>
        <Create onSuccess={handleCreateSuccess} onCancel={handleCreateCancel} />
      </Dialog>
