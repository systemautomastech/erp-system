...
namespace Automas\SupportTicket\Http\Controllers\Company;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Automas\SupportTicket\Models\TicketField;
use Automas\SupportTicket\Http\Requests\UpdateSupportSettingsRequest;

class SettingsController extends Controller
{
    public function update(UpdateSupportSettingsRequest $request)
    {
