...
use Automas\SupportTicket\Http\Requests\StoreFaqRequest;
use Automas\SupportTicket\Http\Requests\UpdateFaqRequest;
use Automas\SupportTicket\Events\CreateFaq;
use Automas\SupportTicket\Events\UpdateFaq;
use Automas\SupportTicket\Events\DestroyFaq;
...
class FaqController extends Controller
{
    ...
    public function store(StoreFaqRequest $request)
    {
        if (Auth::user()->can('create-faq')) {
            ...
            CreateFaq::dispatch($request, $faq);
    ...
    public function update(UpdateFaqRequest $request, Faq $supportTicketFaq)
    {
        if (Auth::user()->can('edit-faq')) {
            ...
            UpdateFaq::dispatch($request, $supportTicketFaq);
    ...
    public function destroy(Faq $supportTicketFaq)
    {
        if (Auth::user()->can('delete-faq')) {
            DestroyFaq::dispatch($supportTicketFaq);
