...
class Project extends Model
{
    ...
    {
        return $this->hasMany(\Automas\Taskly\Models\ProjectMilestone::class);
    }

    public function tasks()
    {
        return $this->hasMany(\Automas\Taskly\Models\ProjectTask::class);
    }

    public function bugs()
    {
        return $this->hasMany(\Automas\Taskly\Models\ProjectBug::class);
    }

    public function activityLogs()
    {
        return $this->hasMany(\Automas\Taskly\Models\ActivityLog::class);
    }

    public function files()
    {
        return $this->hasMany(\Automas\Taskly\Models\ProjectFile::class);
    }
