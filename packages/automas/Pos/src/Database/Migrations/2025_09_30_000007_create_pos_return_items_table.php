    ...
    public function up(): void
    {
        if (!Schema::hasTable('pos_return_items')) {
            Schema::create('pos_return_items', function (Blueprint $table) {
                ...
                $table->unsignedBigInteger('original_pos_item_id');
                ...
                $table->decimal('return_discount_amount', 10, 2)->default(0)->nullable();
                $table->decimal('original_item_discount', 10, 2)->default(0)->nullable();
